...
function renderLowongan(container) {
  const jobs = [
    ...
    { title: "Kasir", type: "Full Time", salary: "Rp 2.000.000 - Rp 2.500.000", requirement: "Ramah, komunikatif, menguasai WA & sosial media", icon: "fa-headset" },
     { title: "Kasir", type: "Part Time", salary: "Rp 500.000 - Rp 1.000.000", requirement: "Ramah, komunikatif, menguasai WA & sosial media", icon: "fa-headset" },
    { title: "Crew Operational", type: "Internship", salary: "Rp 1.500.000", requirement: "Memiliki Motor, Mempunyai Skill Maintenance ", icon: "fa-graduation-cap" }
  ];
